...
ActiveRecord::Schema.define(version: 2021_10_11_024946) do
  ...
  create_table "active_storage_variant_records", force: :cascade do |t|
    ...
    t.index ["sample_indicator_id"], name: "index_active_storage_variant_records_on_sample_indicator_id"
  end
  ...
  create_table "paypal_commerce_platform_sources", force: :cascade do |t|
    ...
    t.string "sample_indicator_id"
    t.index ["sample_indicator_id"], name: "index_paypal_commerce_platform_sources_on_sample_indicator_id"
  end
  ...
  create_table "spree_collaborators", force: :cascade do |t|
    t.string "name"
    t.string "address"
  ...
  create_table "spree_purchase_policies", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "spree_purchase_policy_types", force: :cascade do |t|
    t.integer "user_id"
    t.text "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
